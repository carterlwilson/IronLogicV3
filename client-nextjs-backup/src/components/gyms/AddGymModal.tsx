...
interface AddGymModalProps {
  opened: boolean;
  onClose: () => void;
  onSubmit: (gymData: CreateGymData) => Promise<boolean>;
  gymOwners: GymOwner[];
  loading?: boolean;
}
...
export function AddGymModal({
  ...
  const handleSubmit = async (values: FormData) => {
    ...
    const success = await onSubmit(gymData);
    if (success) {
      form.reset();
      onClose();
    }
        ...
        <Stack gap="md">
          ...
          <div>
            ...
            <Stack gap="sm">
              ...
              <Select
                label="Gym Owner (Optional)"
                placeholder="Select gym owner (can be assigned later)"
          ...
          <Accordion variant="contained">
            <Accordion.Item value="settings">
              <Accordion.Control>
                <Text fw={500}>Gym Settings (Optional)</Text>
              </Accordion.Control>
              <Accordion.Panel>
                <Stack gap="sm">
                  <Grid>
